...
import '/resources/assets.gen.dart' as asset;
...
class AppColors {
  ...
  static const colorPrimary = Color(0xFF711DB0);
  static const colorSecondary = Color(0xFFFFA732);
  ...
  static const background = Color(0xFFF5EAEC);
  static const surface = Color(0xFFFFFFFF);

  // others
  static const pink = Color(0xFFFDCAFF);
  static const pinkSecondary = Color(0xFFFACBCC);
  static const blue = Color(0xFFB9EEFF);
